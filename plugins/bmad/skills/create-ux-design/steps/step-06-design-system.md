...
- Read fully and follow: ${CLAUDE_PLUGIN_ROOT}/skills/advanced-elicitation/workflow.xml with the current design system content
...
- Read fully and follow: ${CLAUDE_PLUGIN_ROOT}/skills/party-mode/SKILL.md with the current design system choice
...
- Load `${CLAUDE_PLUGIN_ROOT}/skills/create-ux-design/steps/step-07-defining-experience.md`
...
After user selects 'C' and content is saved to document, load `${CLAUDE_PLUGIN_ROOT}/skills/create-ux-design/steps/step-07-defining-experience.md` to define the core user interaction.
