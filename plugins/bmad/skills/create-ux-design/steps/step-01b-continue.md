...
- If `lastStep = 1` → Load `${CLAUDE_PLUGIN_ROOT}/skills/create-ux-design/steps/step-02-discovery.md`
- If `lastStep = 2` → Load `${CLAUDE_PLUGIN_ROOT}/skills/create-ux-design/steps/step-03-core-experience.md`
- If `lastStep = 3` → Load `${CLAUDE_PLUGIN_ROOT}/skills/create-ux-design/steps/step-04-emotional-response.md`
