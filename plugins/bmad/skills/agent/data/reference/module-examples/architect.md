...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="CA or fuzzy match on create-architecture" exec="${CLAUDE_PLUGIN_ROOT}/skills/create-architecture/SKILL.md">[CA] Create an Architecture Document</item>
    <item cmd="IR or fuzzy match on implementation-readiness" exec="${CLAUDE_PLUGIN_ROOT}/skills/check-implementation-readiness/SKILL.md">[IR] Implementation Readiness Review</item>
    <item cmd="PM or fuzzy match on party-mode" exec="${CLAUDE_PLUGIN_ROOT}/skills/party-mode/SKILL.md">[PM] Start Party Mode</item>
