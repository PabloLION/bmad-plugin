...
- The `${CLAUDE_PLUGIN_ROOT}/_shared/tasks/validate-workflow.xml` framework will automatically:
...
3. **Load validation framework**: `${CLAUDE_PLUGIN_ROOT}/_shared/tasks/validate-workflow.xml`
