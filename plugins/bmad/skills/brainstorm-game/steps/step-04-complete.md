...
# Path Definitions
workflow_path: '${CLAUDE_PLUGIN_ROOT}/skills/brainstorm-game'
...
# Handoff References
gameBriefWorkflow: '${CLAUDE_PLUGIN_ROOT}/skills/game-brief/SKILL.md'
gddWorkflow: '${CLAUDE_PLUGIN_ROOT}/skills/gdd/SKILL.md'
---
