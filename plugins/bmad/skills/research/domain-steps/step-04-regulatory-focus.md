...
- Load: `${CLAUDE_PLUGIN_ROOT}/skills/research/domain-steps/step-05-technical-trends.md`
...
After user selects 'C' and content is saved to document, load `${CLAUDE_PLUGIN_ROOT}/skills/research/domain-steps/step-05-technical-trends.md` to analyze technical trends and innovations in the domain.
