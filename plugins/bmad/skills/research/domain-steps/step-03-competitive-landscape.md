...
- Load: `${CLAUDE_PLUGIN_ROOT}/skills/research/domain-steps/step-04-regulatory-focus.md`
...
After user selects 'C', load `${CLAUDE_PLUGIN_ROOT}/skills/research/domain-steps/step-04-regulatory-focus.md` to analyze regulatory requirements, compliance frameworks, and legal considerations for {{research_topic}}.
