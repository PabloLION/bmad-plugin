...
- Load: `${CLAUDE_PLUGIN_ROOT}/skills/research/technical-steps/step-05-implementation-research.md`
...
After user selects 'C' and content is saved to document, load `${CLAUDE_PLUGIN_ROOT}/skills/research/technical-steps/step-05-implementation-research.md` to focus on implementation approaches and technology adoption.
