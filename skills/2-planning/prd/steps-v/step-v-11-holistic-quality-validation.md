...
description:
  "Holistic Quality Assessment - Assess PRD as cohesive, compelling document -
  is it a good PRD?"
...
Assess the PRD as a cohesive, compelling document - evaluating document flow,
dual audience effectiveness (humans and LLMs), BMAD PRD principles compliance,
...
- Available context: Complete PRD file, validation report with findings from
  steps 1-10
...
"Perform holistic quality assessment on this PRD using multi-perspective
evaluation:
...
**4. Overall Quality Rating:** Rate the PRD on 5-point scale:
...
**5. Top 3 Improvements:** Identify the 3 most impactful improvements to make
this a great PRD

Return comprehensive assessment with all perspectives, rating, and top 3
improvements."
...
**Areas for Improvement:** {List key weaknesses}
...
1. **{Improvement 1}** {Brief explanation of why and how}

2. **{Improvement 2}** {Brief explanation of why and how}

3. **{Improvement 3}** {Brief explanation of why and how}
...
**Master Rule:** This evaluates the WHOLE document, not just components. Answers
"Is this a good PRD?" and "What would make it great?"
